...
sleep 6
xterm  -e  " source $CATKIN_DIR/devel/setup.bash; rosservice call /gazebo/set_model_state '{model_state: { model_name: mobile_base, pose: { position: { x: 5.0, y: -8.75 ,z: 0.01 }, orientation: {x: 0, y: 0, z: 0, w: 0}}}}'" &
sleep 6
